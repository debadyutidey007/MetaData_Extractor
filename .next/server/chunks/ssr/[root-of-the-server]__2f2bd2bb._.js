...
;
;
const usernameValidation = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["z"].string().min(3, "Username must be at least 3 characters long.").max(20, "Username must be no more than 20 characters long.").regex(/^[a-zA-Z0-9_]+$/, "Username can only contain letters, numbers, and underscores.");
    ...
    const onSubmit = async (values)=>{
        ...
        try {
            ...
            try {
                ...
                console.error("Firebase Auth Error:", authError); // Log authentication errors
                throw authError; // Re-throw to be caught by the main catch block
            }
            ...
            try {
                ...
                throw firestoreError; // Re-throw the error to be caught by the main catch block
            }
            toast({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2f2bd2bb._.js.map